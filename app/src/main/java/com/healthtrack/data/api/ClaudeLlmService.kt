...
Based on remaining daily targets and the user's medical conditions, suggest 2-3 practical meal options. Keep suggestions concise. Respect all medical restrictions.
            """.trimIndent()
